...
export default function LorcanaClockSelection() {
  ...
  const clockTypes = [
    { 
      ...
      route: '/lorcana/clocktwoplayer' as Href
    },
    { 
      id: 'single', 
      name: 'Single Clock', 
      description: 'Game time limit',
      route: '/lorcana/clocksingle' as Href
    },
    { 
      id: 'stopwatch', 
      name: 'Stopwatch', 
      description: 'Count up timer',
      route: '/lorcana/clockstopwatch' as Href
    }
  ];
